        ...
        <div v-else>
            <div class="top ui equal width grid middle aligned">
                ...
                <div class="column right aligned">
                    <button @click.stop="showAddUserDialog = true" class="ui primary button icon"><i
                            class="ui icon add"></i>&nbsp;New User</button>
                </div>
            </div>
                        ...
                        <div class="two column row">
                            ...
                            <div class="three wide column right aligned">
                                <button @click.stop="handleDelete(u)" class="ui button icon small negative"
                                    :class="{ loading: u.deleting }" :disabled="u.deleting || u.username === 'admin'"><i
