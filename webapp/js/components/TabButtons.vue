<template>
    <div class="buttons">
        <div v-for="t in tabs" class="tab-button"
            :class="{ active: activeTab === t.key, top: position === 'top', canClose: !!t.canClose }"
            @click="setActiveTab(t)">
            <i class="icon" :class="{ padded: !!t.hideLabel, [t.icon]: true }" :title="t.label" /><span
